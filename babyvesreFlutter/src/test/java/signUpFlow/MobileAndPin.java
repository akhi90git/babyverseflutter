...
public class MobileAndPin extends StoryScreen {
	...
	public void emptyOTPValidation() throws InterruptedException {
		...
		String validation = driver.findElementByAccessibilityId("Please enter the OTP")
				.getAttribute("content-desc");
		// System.out.println(validation);

		if (validation.equals("Please enter the OTP")) {
			System.out.println("Please enter the OTP validation Matched");
		} else {
			System.out.println("Please enter the OTP not Matched");
		}
	}
...
//	@Test(priority = 12) //abhi mat kar isko
	...
	public void emptyPinValidation() throws InterruptedException {
		...
		if (validation.equals(" Please enter your 4-digit PIN")) {
			System.out.println("Please enter your 4-digit PIN Matched");
		} else {
			System.out.println("Please enter your 4-digit PIN not Matched");
		}
...
//	@Test(priority = 16)
/*	public void clickandEnterPin() throws InterruptedException {
